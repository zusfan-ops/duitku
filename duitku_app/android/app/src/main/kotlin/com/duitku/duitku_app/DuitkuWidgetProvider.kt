    ...
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            try {
                ...
                Log.d(TAG, "Standard widget [$appWidgetId]: balance=$balance, income=$income, expense=$expense, month=$month")
                ...
                Log.e(TAG, "Standard widget [$appWidgetId] onUpdate failed", e)
            }
        }
    }

    companion object {
        private const val TAG = "DuitkuWidgetProvider"
