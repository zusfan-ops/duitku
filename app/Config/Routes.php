...
$routes->post('/chat/status/create',                 'MarketplaceController::createStatus', ['filter' => 'auth']);
$routes->post('/status/comment',                     'MarketplaceController::commentStatus', ['filter' => 'auth']);
$routes->post('/chat/status/comment',                'MarketplaceController::commentStatus', ['filter' => 'auth']);
$routes->get('/status/(:num)/comments',              'MarketplaceController::statusComments/$1', ['filter' => 'auth']);
$routes->get('/chat/status/comments/(:num)',         'MarketplaceController::statusComments/$1', ['filter' => 'auth']);
$routes->post('/status/delete/(:num)',               'MarketplaceController::deleteStatus/$1', ['filter' => 'auth']);
$routes->post('/chat/status/delete/(:num)',          'MarketplaceController::deleteStatus/$1', ['filter' => 'auth']);
